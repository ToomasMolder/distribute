...
function main() {
  ...
  if [ "${TEST}" == "y" ]; then
    ...
    update ${LOCALREPO}/.my_profile ${HOME}/.profile; # source ${HOME}/.profile
    update ${LOCALREPO}/.my_bashrc ${HOME}/.bashrc; source ${HOME}/.bashrc
    update ${LOCALREPO}/.my_bash_aliases ${HOME}/.bash_aliases; source ${HOME}/.bash_aliases
    ...
    printf "==> ${HOME}/.config/htop/htoprc"
